                    ...
                    <div class="col-12 col-md-8">
                        <div class="dash_nav">
                            <nav class="navbar navbar-expand-sm bg-light navbar-light">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="consolidation_merge_request.php">Pending Requestes</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="consolidation_merge_request_completed.php">Completed Requestes</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                            ...
                            <table class="table  table-hover ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#merge_consoli_packge">Consolidate Merge this Package</a>
                                        </td>
                                    </tr>
