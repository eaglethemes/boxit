                    ...
                    <div class="col-12 col-md-8">
                        <div class="dash_nav">
                            <nav class="navbar navbar-expand-sm bg-light navbar-light">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="inspection_request.php">Pending Requestes</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="inspection_request_completed.php">Completed Requestes</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 230px;">
                                            <span class="status pend_inspect"><i data-lucide="scan-eye"></i> Pending Inspection</span>
                                        </td>
                                        <td>
                                            <a href="#" class="btn btn-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#Inspec_report">Inspect Now</a>
                                        </td>
                                    </tr>
