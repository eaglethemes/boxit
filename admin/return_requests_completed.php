                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Retrun Package Requests</li>
                        </ol>
                    </nav>
                </div>
                <h2>Retrun Package Requests</h2>
                    ...
                    <div class="col-12 col-md-8">
                        <div class="dash_nav">
                            <nav class="navbar navbar-expand-sm bg-light navbar-light">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link " href="return_requests.php">Pending Requestes</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="return_requests_completed.php">Completed Requestes</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 230px;">
                                            <span class="status comp_return"><i data-lucide="rotate-ccw"></i> Completed Request</span>
                                        </td>
                                        <td>
                                            The package has been returned to store on 12/12/12 09:39
                                        </td>
                                    </tr>
