                    ...
                    <div class="col-12 col-md-8">
                        <div class="dash_nav">
                            <nav class="navbar navbar-expand-sm bg-light navbar-light">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link " href="trash_requests.php">Pending Requestes</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="trash_requests_completed.php">Completed Requestes</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 230px;">
                                            <span class="status comp_trash"><i data-lucide="trash"></i> Completed Request</span>
                                        </td>
                                        <td>
                                            Package has been trashed on 12/12/12 09:23
                                        </td>
                                    </tr>
