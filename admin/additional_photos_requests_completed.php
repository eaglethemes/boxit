                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Additional Photos Requests</li>
                        </ol>
                    </nav>
                </div>
                <h2>Additional Photos Requests</h2>
                    ...
                    <div class="col-12 col-md-8">
                        <div class="dash_nav">
                            <nav class="navbar navbar-expand-sm bg-light navbar-light">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link " href="additional_photos_requests.php">Pending Requestes</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="additional_photos_requests_completed.php">Completed Requestes</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 230px;">
                                            <span class="status comp_photos"><i data-lucide="camera"></i> Completed Request</span>
                                        </td>
                                        <td>
                                            <a href="#" class="btn btn-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#addtion_photos">View Photos</a>
                                        </td>
                                    </tr>
